...
class DSLGrammarParser ( Parser ):
    ...
    class RContext(ParserRuleContext):
        ...
        def ID(self):
            return self.getToken(DSLGrammarParser.ID, 0)

        def getRuleIndex(self):
            return DSLGrammarParser.RULE_r
    ...
    def r(self):
        ...
        localctx = DSLGrammarParser.RContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 3
            self.match(DSLGrammarParser.ID)
