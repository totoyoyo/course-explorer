import data.model.attribute.num_piazza_actions as num_piazza_actions
...
import data.model.attribute.num_piazza_questions as num_piazza_questions
import data.model.attribute.num_piazza_answers as num_piazza_answers



def make_attribute(name):
    match name:
        case 'num_piazza_actions':
            return num_piazza_actions.NumPiazzaActions()
        case 'num_piazza_answers':
            return num_piazza_answers.NumPiazzaAnswers()
        case 'num_piazza_questions':
            return num_piazza_questions.NumPiazzaQuestions()
        case 'num_commits':
